...
module PairwiseFeature = struct
  ...
  type feature = Method.t * Method.t -> bool

  type t = {label: string; feature: feature}

  let is_both_framework_code : feature =
   fun ((method1, method2) : Method.t * Method.t) : bool ->
    is_framework_method method1 && is_framework_method method2


  let belong_to_same_class : feature =
   fun ((method1, method2) : Method.t * Method.t) : bool ->
  ...
  let is_both_initializer : feature =
   fun ((method1, method2) : Method.t * Method.t) : bool ->
    let method1_is_init = is_initializer method1 and method2_is_init = is_initializer method2 in
    method1_is_init && method2_is_init


  let has_same_annots : feature =
   fun ((method1, method2) : Method.t * Method.t) : bool ->
  ...
  let all_features =
    [| {label= "is_both_framework_code"; feature= is_both_framework_code}
     ; {label= "belong_to_same_class"; feature= belong_to_same_class}
     ; {label= "belong_to_same_package"; feature= belong_to_same_package}
     ; {label= "return_type_is_another's_class"; feature= return_type_is_another's_class}
     ; {label= "is_both_java_builtin"; feature= is_both_java_builtin}
     ; {label= "is_both_initializer"; feature= is_both_initializer}
     ; {label= "has_same_annots"; feature= has_same_annots} |]
end
