let sagan_solution = [("String SpringToolsController.listDownloads(Model)", ["src"; "sin"]);
                      ...
                      ("ResponseEntity DocsWebhookController.processGuidesUpdate(String,String,String)", ["src"; "sin"]);
                      ("ResponseEntity DocsWebhookController.processTopicalsUpdate(String,String,String,String)", ["src"; "sin"]);
                      ("ResponseEntity DocsWebhookController.processTutorialsUpdate(String,String,String,String)", ["src"; "sin"]);
                      ("ResponseEntity DocsWebhookController.handleWebhookAuthenticationFailure(WebhookAuthenticationException)", ["src"; "sin"]);
                      ...
                      ("ResponseEntity DocsWebhookController.processTutorialsUpdate(String,String,String)", ["src"; "sin"]);
                      ("ResponseEntity DocsWebhookController.processGuidesUpdate(String,String,String,String)", ["src"; "sin"]);
                      ...
                      ("ProjectRelease ProjectMetadataController.updateReleaseMetadata(String,ProjectRelease)", ["src"; "sin"]);
                      ...
                      ("ProjectRelease ProjectMetadataController.removeReleaseMetadata(String,String)", ["src"; "sin"]);
                      ...
                      ("ProjectPatchingService$ObjectPatcher ProjectPatchingService$ObjectPatcher.patch(Object,Object)", ["non"]);
                      ("Object ProjectPatchingService$ObjectPatcher.patchedValue()", ["non"]);
                      ("ProjectPatchingService$ObjectPatcher ProjectPatchingService$ObjectPatcher.mutateIfDirty(Function,BiConsumer)", ["non"]);
                      ...
                      ("String BlogAdminController.createPost(Principal,PostForm,BindingResult,Model)", ["src"; "sin"]);
                      ...
                      ("void AtomFeedController.prepareResponse(Model,HttpServletResponse,Page,String,String)", ["non"]);
                      ("AtomFeedView AtomFeedController.listPublishedBroadcastPosts(Model,HttpServletResponse)", ["src"; "sin"]);
                      ("AtomFeedView AtomFeedController.listPublishedPosts(Model,HttpServletResponse)", ["src"; "sin"]);
                      ("AtomFeedView AtomFeedController.listPublishedPostsForCategory(PostCategory,Model,HttpServletResponse)", ["src"; "sin"]);
                      ...
                      ("Authentication SecurityConfig$ApiAuthenticationConfig$1.authenticate(Authentication)", ["san"]);
                      ("String SecurityConfig$RemoteUsernameConnectionSignUp.execute(Connection)", ["sin"]); (* UNSURE *)
                      ("void SecurityConfig$AdminAuthenticationConfig$1.doFilterInternal(HttpServletRequest,HttpServletResponse,FilterChain)", ["san"]);
                      ("AuthenticationManager SecurityConfig$ApiAuthenticationConfig.githubAuthenticationManager()", ["san"]);
                      ("void SecurityConfig.configureHeaders(HeadersConfigurer)", ["non"]);
                      ("String SecurityConfig$GithubAuthenticationSigninAdapter.signIn(String,Connection,NativeWebRequest)", ["non"]);
                      ...
                      ("ConnectionFactoryRegistry SecurityConfig$AdminAuthenticationConfig.connectionFactoryRegistry()", ["non"]);
                      ("Authentication SecurityConfig$SecurityContextAuthenticationFilter.attemptAuthentication(HttpServletRequest,HttpServletResponse)", ["non"]);
                      ...
                      ("InMemoryUsersConnectionRepository SecurityConfig$AdminAuthenticationConfig.inMemoryUsersConnectionRepository(ConnectionFactoryRegistry)", ["non"]);
                      ("Filter SecurityConfig$SigninAuthenticationConfig.authenticationFilter()", ["non"]);
                      ("AuthenticationEntryPoint SecurityConfig$AdminAuthenticationConfig.authenticationEntryPoint()", ["non"]);
                      ...
                      ("ProviderSignInController SecurityConfig$AdminAuthenticationConfig.providerSignInController(GitHubConnectionFactory,ConnectionFactoryRegistry,InMemoryUsersConnectionRepository)", ["non"]);
                      ...
                      ("void MvcConfig$1.postHandle(HttpServletRequest,HttpServletResponse,Object,ModelAndView)", ["non"]);
                      ...
                      ("ClientHttpResponse GithubClient$GithubAcceptInterceptor.intercept(HttpRequest,byte[],ClientHttpRequestExecution)", ["non"]);
                      ("List GithubClient.fetchOrgRepositories(String)", ["non"]);
                      ("ClientHttpResponse GithubClient$GithubAppTokenInterceptor.intercept(HttpRequest,byte[],ClientHttpRequestExecution)", ["non"]);
                      ...
                      ("ChannelSecurityConfigurer$ChannelRequestMatcherRegistry ChannelSecurityConfigurer$RequiresChannelUrl.requiresSecure()", ["san"]);
                      ...
                      ("ExceptionHandlingConfigurer ExceptionHandlingConfigurer.authenticationEntryPoint(AuthenticationEntryPoint)", ["san"]);
                      ("ExpressionUrlAuthorizationConfigurer$ExpressionInterceptUrlRegistry ExpressionUrlAuthorizationConfigurer$AuthorizedUrl.authenticated()", ["san"]);
                      ("ExpressionUrlAuthorizationConfigurer$ExpressionInterceptUrlRegistry ExpressionUrlAuthorizationConfigurer$AuthorizedUrl.permitAll()", ["san"]);
                      ...
                      ("ExpressionUrlAuthorizationConfigurer$ExpressionInterceptUrlRegistry HttpSecurity.authorizeRequests()", ["san"]);
                      ("HttpSecurity$RequestMatcherConfigurer HttpSecurity.requestMatchers()", ["san"]);
                      ("ChannelSecurityConfigurer$ChannelRequestMatcherRegistry HttpSecurity.requiresChannel()", ["san"]);
                      ...
                      ("ConnectionRepository InMemoryUsersConnectionRepository.createConnectionRepository(String)", ["non"]);
                      ...
                      ("VersionResourceResolver VersionResourceResolver.addFixedVersionStrategy(String,String[])", ["non"]);
